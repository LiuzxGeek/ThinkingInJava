...
public class TestSixteen {
	public static void main(String[] args) {
		...
		System.out.println(Integer.toHexString(255 * 12 / 100));
		...
		System.out.println("40：" + Integer.toHexString(255 * 40 / 100));
		System.out.println(Integer.toHexString(255 * 60 / 100));// 99
		System.out.println(Integer.toHexString(255 * 75 / 100));
		System.out.println(Integer.toHexString(255 * 80 / 100));//cc
		System.out.println(Integer.toHexString(255 * 85 / 100));
		System.out.println(Integer.toHexString(255 * 90 / 100));
		System.out.println(Integer.toHexString(255 * 100 / 100));
		// int lastTime = 40000;
